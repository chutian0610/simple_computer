...
class LogicalDecoderTest {
    ...
    public void input00(){
        ...
        Potential[] result= CircuitUtils.compute(decoder, Potentials.fromText("00"));
        Assertions.assertEquals("0001", Potentials.toText(result));
    }
    @Test
    public void input01(){
        LogicalDecoder decoder = new LogicalDecoder(2);
        Potential[] result= CircuitUtils.compute(decoder, Potentials.fromText("01"));
        Assertions.assertEquals("0010", Potentials.toText(result));
    }
    @Test
    public void input10(){
        LogicalDecoder decoder = new LogicalDecoder(2);
        Potential[] result= CircuitUtils.compute(decoder, Potentials.fromText("10"));
